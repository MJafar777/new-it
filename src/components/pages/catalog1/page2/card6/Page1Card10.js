...
export default function Page1Card10() {
  return (
    <Box>
      ...
      component="div"
      variant = "h5"
      sx={{fontWeight : "500", textAlign:"center", margin: 5, zIndex: 2,}}
      >Мы отличаемся тремя преимуществами</Typography>
    <Box className="category1-page1-card10-component">
          {advantageData.map((item, i) => {
              ...
              sx={{
                ...
                padding: '10%',
                borderRadius: "2px",
                background: "rgba(165, 165, 245, 0.25)",
                marginTop: 5,
                display: "grid",
...
const advantageData = [
  {
    advantageIcon: <SignLanguageSharpIcon />,
  ...
  {
    advantageIcon: <ThumbUpSharpIcon />,
